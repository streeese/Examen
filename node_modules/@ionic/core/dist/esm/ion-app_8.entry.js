...
import { c as createKeyboardController } from './keyboard-controller-71166726.js';
...
import { t as transition } from './index-fc6b0703.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-b5cc622b.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          ...
          import('./input-shims-fad12254.js').then((module) => module.startInputShims(config, platform));
        }
