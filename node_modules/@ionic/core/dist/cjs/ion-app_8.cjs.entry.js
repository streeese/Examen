...
const keyboardController = require('./keyboard-controller-816989c4.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-7d1aaa82.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
